...
```{r save philly}
saveRDS(tmp, "data/philly_neighborhood_incident_count.RDS")
```
...
```{r}
saveRDS(tmp, "data/pitt_neighborhood_incident_count.RDS")
```
...
```{r}
saveRDS(tmp, "data/la_neighborhood_incident_count.RDS")
```
...
```{r}
saveRDS(tmp, "data/sf_neighborhood_incident_count.RDS")
```
